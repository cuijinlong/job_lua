...
if string.len(right_question_ids) > 0 then
	...
	for i=1,#right_question_id_array do
		...
		if is_exsit[1] == "0" then
           wrongQuestionBookModel:wq_rate(class_id,question_id,subject_id,question_info["knowledge_point_ids"],question_info["knowledge_point_codes"],question_info["question_type_id"],question_info["question_type_name"],question_info["nd_id"],question_info["nd_name"],1);--该班级这道题的对题个数+1
		end
